...
param_grid = [
    ...
    # As the size of the filter layers has proven irrelevant, I will not vary them in the final search

    # Group 1: Refined Grid Best AUC Space
    {"lr": 0.00005, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]}, # Refined Grid best AUC
    {"lr": 0.000025, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.00005, "dropout": 0.45, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.00005, "dropout": 0.55, "conv_filters": [64, 128, 256, 512]},

    # Group 2: Refined Grid Second Best AUC Space
    {"lr": 0.00005, "dropout": 0.3, "conv_filters": [16, 32, 64, 128]}, # Refined Grid second best AUC
    {"lr": 0.000025, "dropout": 0.3, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.00005, "dropout": 0.25, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.00005, "dropout": 0.35, "conv_filters": [16, 32, 64, 128]},
...
results_file = "/home/justincb/models/final_results_D1_rgb.csv"
results = []
