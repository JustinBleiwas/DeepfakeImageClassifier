...
rgb_model = load_model("/home/justincb/models/best_rgb_model_D1.h5")
dct_model = load_model("/home/justincb/models/best_dct_model_D1.h5")
srm_model = load_model("/home/justincb/models/best_srm_model_D1.h5")
print("Models loaded.")
...
X_train = np.concatenate([X_rgb_train, X_dct_train, X_srm_train], axis=1)
X_val   = np.concatenate([X_rgb_val,   X_dct_val,   X_srm_val],   axis=1)
X_test  = np.concatenate([X_rgb_test,  X_dct_test,  X_srm_test],  axis=1)
...
results_file = "/home/justincb/models/ensemble_hparam_results_D1.csv"
results = []

best_auc = -1
best_model_path = "/home/justincb/models/best_ensemble_model_D1.h5"
