...
param_grid = [
    ...
    # In this case, the best base grid AUC is useless as it led to a metric change

    # Group 1: Refined Grid Best AUC Space
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [64, 128, 256, 512]}, # Refined Grid best AUC
    {"lr": 0.00025, "dropout": 0.4, "conv_filters": [64, 128, 256, 512]},
    ...
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [32, 64, 128, 256]}, # Refined Grid second best AUC
    ...
    # Group 3: Between the two best Architectures
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.0005, "dropout": 0.5, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.0001, "dropout": 0.4, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [48, 96, 192, 384]},
]

results_file = "/home/justincb/models/final_results_merged_dct_AUC.csv"
results = []
