...
param_grid = [
    # Light
    {"lr": 0.0001, "dropout": 0.2, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.0005, "dropout": 0.2, "conv_filters": [16, 32, 64, 128]},

    # Medium
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0005, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.001, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.001, "dropout": 0.4, "conv_filters": [32, 64, 128, 256]},

    # Medium-Heavy
    {"lr": 0.0005, "dropout": 0.3, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.001, "dropout": 0.3, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [48, 96, 192, 384]},
    {"lr": 0.001, "dropout": 0.4, "conv_filters": [48, 96, 192, 384]},

    # Heavy
    {"lr": 0.0001, "dropout": 0.4, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.001, "dropout": 0.4, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.0005, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.001, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},

    # Extra-Heavy
    {"lr": 0.0005, "dropout": 0.4, "conv_filters": [96, 192, 384, 768]},
    {"lr": 0.001, "dropout": 0.4, "conv_filters": [96, 192, 384, 768]},
    {"lr": 0.0005, "dropout": 0.5, "conv_filters": [96, 192, 384, 768]},
    {"lr": 0.001, "dropout": 0.5, "conv_filters": [96, 192, 384, 768]},

    # Mixture
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [32, 64, 64, 128]},
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [32, 64, 128, 256]},
]

results_file = "/home/justincb/models/hparam_results_merged_srm_refined.csv"
results = []

best_auc = -1
best_model_path = "/home/justincb/models/best_srm_model_merged.h5"
