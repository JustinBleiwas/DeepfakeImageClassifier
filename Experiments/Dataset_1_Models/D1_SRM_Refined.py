...
param_grid = [ # Higher dropout rates perfomed best in the base grid. Learning rate had no impact, and grid size had minimal impact.
    # Light
    {"lr": 0.0001, "dropout": 0.2, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.0005, "dropout": 0.2, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [16, 32, 64, 128]},
    {"lr": 0.0005, "dropout": 0.3, "conv_filters": [16, 32, 64, 128]},

    # Medium (baseline)
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0005, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0001, "dropout": 0.4, "conv_filters": [32, 64, 128, 256]},
    ...
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},
    {"lr": 0.0005, "dropout": 0.5, "conv_filters": [64, 128, 256, 512]},

    # Mixture
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [32, 64, 64, 128]}, # Performed second best in the base grid search
    {"lr": 0.0001, "dropout": 0.4, "conv_filters": [32, 64, 64, 128]},
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [32, 64, 128, 256]}, # Best model from base grid search
    {"lr": 0.0001, "dropout": 0.6, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [48, 96, 192, 384]}, # Add a between-size grid
    {"lr": 0.0001, "dropout": 0.6, "conv_filters": [48, 96, 192, 384]}, # Add a between-size grid
]

results_file = "/home/justincb/models/srm_hparam_results_D1_refined.csv"
results = []
