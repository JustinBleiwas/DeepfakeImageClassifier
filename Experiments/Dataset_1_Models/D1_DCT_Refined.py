...
param_grid = [ # In the base grid, medium size was consistently best. Heavy did better than small.
    # Light
    ...
    {"lr": 0.0001, "dropout": 0.2, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0005, "dropout": 0.2, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.00005, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0001, "dropout": 0.3, "conv_filters": [32, 64, 128, 256]}, # Best model from base grid search
    ...
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [32, 64, 128, 256]}, # Tied for best model from base grid search
    {"lr": 0.0005, "dropout": 0.5, "conv_filters": [32, 64, 128, 256]},
    {"lr": 0.0001, "dropout": 0.4, "conv_filters": [48, 96, 192, 384]}, # Add a between-size grid
    {"lr": 0.0001, "dropout": 0.5, "conv_filters": [48, 96, 192, 384]},
]

results_file = "/home/justincb/models/dct_hparam_results_D1_refined.csv"
results = []
